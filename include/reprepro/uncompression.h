...
retvalue uncompress_checkpid(pid_t, int, InterruptedFT interrupted, int verbose);
...
retvalue uncompress_queue_file(const char *, const char *, enum compression, finishaction *, void *, InterruptedFT interrupted, int verbose);

/**** functions for update.c (uncompressing an earlier downloaded file) ****/

retvalue uncompress_file(const char *, const char *, enum compression, InterruptedFT interrupted, int verbose);
...
retvalue uncompress_open(/*@out@*/struct compressedfile **, const char *, enum compression, InterruptedFT interrupted);
int uncompress_read(struct compressedfile *, void *buffer, int, InterruptedFT interrupted);
retvalue uncompress_error(/*@const@*/struct compressedfile *);
void uncompress_abort(/*@only@*/struct compressedfile *, InterruptedFT interrupted);
retvalue uncompress_close(/*@only@*/struct compressedfile *, InterruptedFT interrupted);
retvalue uncompress_fdclose(/*@only@*/struct compressedfile *, int *, const char **, InterruptedFT interrupted);

retvalue uncompress_fdopen(/*@out@*/struct compressedfile **, int, off_t, enum compression, int *, const char **, InterruptedFT interrupted);
